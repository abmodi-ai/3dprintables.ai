...
import { X, Mail, Lock, User, Loader2, Sparkles, Eye, EyeOff, ArrowLeft, CheckCircle } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[150] flex items-center justify-center p-4">
            ...
            <div className="bg-white rounded-[2.5rem] p-8 md:p-12 max-w-md w-full relative z-10 shadow-2xl animate-scaleIn border-4 border-purple-100">
                ...
                <div className="text-center mb-10">
                    <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 ${mode === 'forgot' && forgotSuccess ? 'bg-green-100' : 'bg-purple-100'}`}>
                    ...
                    <p className="text-gray-500 font-bold mt-2">
                        {mode === 'forgot'
                            ? (forgotSuccess ? '' : "We'll send you a reset link")
                            : mode === 'login' ? 'Sign in to your account' : 'Create an account to save your 3D designs'}
                    </p>
                </div>
                ...
                {mode === 'forgot' ? (
                    <div>
                        ...
                        <button
                            ...
                            className="flex items-center gap-1 text-sm text-purple-500 hover:text-purple-700 font-bold mb-6 hover:underline decoration-2 underline-offset-4 transition-colors"
                        >
                            <ArrowLeft size={16} />
                            Back to Sign In
                        </button>
                        ...
                        {forgotSuccess ? (
                            <div className="text-center py-4">
                                <p className="text-gray-500 font-bold text-sm mb-6">
                                    If an account exists for <strong className="text-gray-700">{forgotEmail}</strong>, we've sent a password reset link. Check your inbox and spam folder.
                                </p>
                                <button
                                    type="button"
                                    onClick={switchToLogin}
