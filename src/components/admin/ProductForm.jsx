        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 animate-fadeIn">
            ...
            <div className="bg-gray-950/50 backdrop-blur-2xl p-10 rounded-[3rem] border border-white/10 shadow-2xl relative overflow-hidden group">
                ...
                <h3 className="text-2xl font-black mb-10 flex items-center gap-4 text-white uppercase tracking-tighter">
                    <Wand2 className="text-purple-500" /> Add New Product
                </h3>

                <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="space-y-4">
                        <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] pl-1">Product Image</label>
                        <div className="border-2 border-dashed border-white/10 rounded-3xl p-8 text-center hover:border-purple-500/50 transition-all bg-white/5 cursor-pointer relative group/upload">
                            ...
                            <div className="pointer-events-none">
                                ...
                                <p className="text-white font-black text-sm uppercase tracking-widest">Upload Image</p>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] pl-1">Weight (grams)</label>
                            <input
                                required
                                type="number"
                                name="weight"
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] pl-1">Print Time (hours)</label>
                            <input
                                required
                                type="number"
                                name="time"
                    ...
                    <div className="space-y-6">
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] pl-1">Product Name</label>
                            <input
                                type="text"
                                name="name"
                                value={formData.name}
                        ...
                        <div className="space-y-3">
                            <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.3em] pl-1">Category</label>
                            <input
                                type="text"
                                name="category"
                                value={formData.category}
                                onChange={handleInputChange}
                                placeholder="e.g. Action, Creative..."
                    ...
                    >
                        <Plus size={24} className="mr-3 inline group-hover:rotate-90 transition-transform" /> Add Product
                    </Button>
                </form>
            </div>
                ...
                <div className="bg-gray-950/30 rounded-[3rem] aspect-square flex items-center justify-center overflow-hidden border border-white/10 relative shadow-inner group">
                    {generatedImage ? (
                        ...
                        <div className="text-gray-700 text-center">
                            ...
                            <p className="font-black uppercase tracking-[0.3em] text-xs">No Image Yet</p>
                            <p className="text-[10px] uppercase font-bold text-gray-800 mt-2">Upload an image to preview</p>
                        </div>
                    )}
                </div>
                ...
                {calculatedPrice && (
                    <div className="bg-gray-950/80 backdrop-blur-2xl p-10 rounded-[3rem] border border-white/10 shadow-2xl animate-fadeIn relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-4 mb-10 text-purple-400">
                            ...
                            <div>
                                <h4 className="font-black text-white uppercase tracking-tighter text-xl">Price Breakdown</h4>
                                <p className="text-[10px] font-black uppercase tracking-widest italic text-gray-500">Cost Calculation</p>
                            </div>
                        </div>

                        <div className="space-y-4 text-xs font-black uppercase tracking-widest">
                            {[
                                { label: 'Material Cost', val: calculatedPrice.breakdown.plastic },
                                { label: 'Machine Time', val: calculatedPrice.breakdown.machine },
                                { label: 'Labor', val: calculatedPrice.breakdown.labor }
                            ].map(stat => (
                            ...
                            <div className="flex justify-between items-center text-sm">
                                <span className="text-white">PRODUCTION COST</span>
                                <span className="text-white">${calculatedPrice.breakdown.production}</span>
                            </div>
                            <div className="flex justify-between items-center text-sm">
                                <span className="text-purple-400">PROFIT MARGIN</span>
                        ...
                        <div className="mt-10 pt-10 border-t border-white/5 text-center">
                            <p className="text-gray-500 text-[10px] font-black uppercase tracking-[0.4em] mb-4">Final Price</p>
